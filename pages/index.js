                ...
                <div className="flex justify-end">
                  <div className="flex w-28 gap-2">
                    <Image
                      ...
                      height={28}
                    />
                    <span className="flex items-center">831hpa</span>
                  </div>
                  <div className="flex w-28 gap-2">
                    <Image
                      src={uvIcon}
                      ...
                      height={28}
                    />
                    <span className="flex items-center">Moderate</span>
                  </div>
                </div>
                <div className="flex mt-2">
                  <div className="flex w-28 gap-2">
                    <Image src={sunriseIcon} alt="Sunrise" height={28} />
                    <span className="flex items-center">6:00</span>
                  </div>
                  <div className="flex w-28 gap-2">
                    <Image src={sunsetIcon} alt="Sunset" height={28} />
                    <span className="flex items-center">18:13</span>
                  </div>
                </div>
              </div>
            </div>
